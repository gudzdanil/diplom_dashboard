...
/***/ function(module, exports, __webpack_require__) {
	...
	var _usersApi = __webpack_require__(8);
	...
	var _connection = __webpack_require__(14);

	var _connection2 = _interopRequireDefault(_connection);

	var _infograph = __webpack_require__(15);

	var _infograph2 = _interopRequireDefault(_infograph);

	var _addModal = __webpack_require__(17);

	var _addModal2 = _interopRequireDefault(_addModal);

	var _users3 = __webpack_require__(18);

	var _users4 = _interopRequireDefault(_users3);

	var _addModal3 = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function routing($stateProvider, $urlRouterProvider) {
	    ...
	    $stateProvider.state('login', {
	        ...
	        abstract: true,
	        templateProvider: ['UsersApiService', '$http', function (api, http) {
	            return api.current().then(function (data) {
	                return http.get('./app/main/global_' + (data.data.role || 'user').toLowerCase() + '.html').then(function (data) {
	                    return data.data;
	                });
	            });
	        }],
	    ...
	    _createClass(UserService, [{
	        ...
	        get: function get() {
	            ...
	            return this._api.current().then(function (data) {
	                return _this3._user.update(data.data);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersController = function () {
	    function UsersController($uibModal, GlobalApiService, UsersApiService) {
	    ...
	    _createClass(UsersController, [{
	        ...
	        value: function getUsers() {
	            ...
	            this._apiUsers.getUsers().then(function (data) {
	        ...
	        value: function add() {
	            ...
	            this._modal.open({
	                ...
	                resolve: {
	                    ...
	                    saveMethod: function saveMethod() {
	                        return angular.bind(_this3._apiUsers, _this3._apiUsers.addUser);
	                    }
	                },
	                size: 'md'
	            }).result.then(function (data) {
	        ...
	        value: function edit(index) {
	            ...
	            this._modal.open({
	                ...
	                resolve: {
	                    ...
	                    saveMethod: function saveMethod() {
	                        return angular.bind(_this4._apiUsers, _this4._apiUsers.editUser);
	                    }
	                },
	                size: 'md'
	            }).result.then(function (data) {
	        ...
	        value: function remove(index) {
	            ...
	            if (confirm("Вы уверены что хотите удалить пользователя " + this.users[index].username + "?")) {
	                this._apiUsers.removeUser(id).then(function () {
